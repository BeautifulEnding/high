...
public class StatusDetailModelImp implements StatusDetailModel {
    private ArrayList<Content> mRepostList = new ArrayList<>();
    ...
    @Override
    public void comment(int groupType, Content status, final Context context, final OnCommentCallBack onCommentCallBack) {
//        CommentsAPI commentsAPI = new CommentsAPI(context, Constants.APP_KEY, AccessTokenKeeper.readAccessToken(context));
    ...
    @Override
    public void commentNextPage(int groupType, Content status, final Context context, final OnCommentCallBack onCommentCallBack) {
        /*CommentsAPI commentsAPI = new CommentsAPI(context, Constants.APP_KEY, AccessTokenKeeper.readAccessToken(context));
        String maxId = "";
    ...
    @Override
    public void repost(int groupType, Content status, final Context context, final OnRepostCallBack onRepostCallBack) {
    ...
    @Override
    public void repostNextPage(int groupType, Content status, final Context context, final OnRepostCallBack onRepostCallBack) {
        /*StatusesAPI statusesAPI = new StatusesAPI(context, Constants.APP_KEY, AccessTokenKeeper.readAccessToken(context));
        String maxId;
