...
public interface UserActivityView {
    ...
    public void updateStatusListView(ArrayList<Content> statuselist, boolean resetAdapter);

    public void updatePhotoListView(ArrayList<Content> statuselist, boolean resetAdapter);
