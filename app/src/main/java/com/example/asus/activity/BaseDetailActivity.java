...
import com.example.asus.adapter.CommentDetailAdapter;
import com.example.asus.adapter.MentionDetailAdapter;
import com.example.asus.entity.Comment;
import com.example.asus.entity.Content;
import com.example.asus.he.R;
import com.example.asus.ui.DetailActivityPresent;
import com.example.asus.ui.DetailActivityPresentImp;
import com.example.asus.ui.FillContent;
import com.example.asus.ui.HeaderAndFooterRecyclerViewAdapter;
import com.example.asus.ui.StatusDetailModelImp;
import com.example.asus.view.DetailActivityView;
import com.example.asus.view.OnDetailButtonClickListener;
...
public abstract class BaseDetailActivity extends BaseActivity implements DetailActivityView {
    ...
    public Content mStatus;
    public ArrayList<Comment> mCommentDatas = new ArrayList<>();
    public ArrayList<Content> mRepostDatas = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initRefreshLayout();
        initRecyclerView();
        mLastestComments = mStatus.getComment();
        mLastestReposts = mStatus.getRetweet();
        mLastestAttitudes = mStatus.getPharise();
...
//            当点击了头部的评论文字时
    ...
    @Override
    public void updateRepostListView(ArrayList<Content> mentionlist, boolean resetAdapter) {
        if (resetAdapter) {
            mNoMoreData = false;
