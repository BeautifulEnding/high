...
//    public static final String FRAGMENT_FLAG_SEND = "发布";
    ...
    //定义SD卡路径
    public static  String SD_PATH= Environment.getExternalStorageDirectory().getAbsolutePath()+"/high/";
...
//    服务器正文图片路径
    ...
    public static  String CHAT_PATH=SD_PATH+"/chat";
//    话题
    ...
    public static final int LOAD_MESSAGELIST=2;
    /**
